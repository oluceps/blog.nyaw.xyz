...
+ Heartrate broadcasting, built on Rust backend with Axum for high-performance WebSocket and gRPC communication. The data layer is powered by Protobuf for efficient binary serialization.

## TODO

- [x] update block
- [x] unlock hiding content with puzzle
