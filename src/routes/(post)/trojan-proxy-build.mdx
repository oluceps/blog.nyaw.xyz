...
> 众所周知，一般来说，基于解决为适应我国国情而做出的部分国际互联网限制所导致的学术信息交流不方便等问题而提出的大多数加密流量型代理协议(SS/SSR等)~~已经不再稳定和安全~~
> <Update date="02 Oct 2021">随着ss项目的进一步发展，似乎其在某些方面比较受大型机场的青睐，安全性现阶段也有保障</Update>
> 众多网友迫切地寻找一款真正能够满足日常需求的代理软件。于是，**v2ray**以及**Trojan**就应运而生。二者都是伪装流量类型的代理方式。
