...
[Nix实现](https://github.com/oluceps/nixos-config/blob/878d2e94f26ef3ab0a7611b719cdaa6d016b6eb9/repack/plugIn.nix)，
...
router id 10.0.0.2; # machine uniq
...
filter to_kernel {
  if source = RTS_BABEL then {
    krt_prefsrc = fdcc::2; # ip of this machine, uniq
    krt_metric = 128;
    accept;
  }
