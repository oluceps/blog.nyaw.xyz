  ...
  return (
    <>
      <div class="h-dvh overflow-hidden">
        <div class="flex-col justify-start h-full w-full bg-transparent overflow-hidden">
          ...
          <div class="grid grid-cols-1 grid-rows-9 sm:grid-cols-9 sm:grid-rows-8 w-full h-full">
            <div class="shadow-xl col-start-1 col-span-1 row-start-3 row-span-3 mx-4 sm:col-start-4 sm:col-span-3 sm:row-start-3 sm:row-span-3 bg-[#fef2f4] rounded-xl">
              <div class="flex justify-evenly content-center items-center h-full w-full">
                ...
                <span class="font-mono text-6xl text-zinc-600 bg-#fef2f40/20 backdrop-blur-lg px-3 pt-3 rounded-md">
