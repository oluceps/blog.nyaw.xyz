...
1. Get pr info, including `merge_commit_sha`

2. `api/compare/${branch}...${merge_commit_sha}`, GitHub will return `diverged | identical | behind`. Later two represents pr in this branch.
