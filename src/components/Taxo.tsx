				...
				cateArtisMap.set(
					...
					preprocessed.filter((a) => {
						if (a.categories && a.categories.length > 0) {
							...
							return a.categories.includes(i as typeof t);
						}
						return false;
					}),
				);
				...
				tagArtisMap.set(
					...
					preprocessed.filter((a) => {
						if (a.tags && a.tags.length > 0) {
							const t = a.tags[0];
							return a.tags.includes(i as typeof t);
						}
						return false;
					}),
				);
								...
								<div class="w-full grid grid-cols-1 md:grid-cols-[1fr_30px_1fr]">
									...
									<div class="max-w-full overflow-hidden antialiased flex flex-col min-h-[50vh] py-4 md:py-10">
										...
										<Show when={(hoverTag() || selectedTag())} fallback={
											...
											<div class="h-full items-start md:justify-center justify-start flex flex-col">
												<div class="flex items-start justify-start w-full font-mono text-slate-400 text-12px">
													Y/M/D
												</div>
												<ul>
													<For
