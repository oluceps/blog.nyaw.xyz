		...
		<>
			<Show when={scroll.y > 350 && document.documentElement.clientWidth > 930}>
				<button
					...
					class="!fixed bottom-5 right-5 p-3 mb-3 backdrop-blur-md bg-sprout-200/60 rounded-md h-9 w-9 grid items-center justify-center duration-200 bg-sprout-300/75 h-9 w-9"
				>
