...
export const TableOfContents: Component<{ children: ResolvedChildren }> = (
	...
	const textAttr = "no-underline font-normal hover:font-semibold";
	const olAttr =
		"pl-2.5 my-0 space-y-px text-xs text-slate-700 list-disc decoration-sprout-300 active:font-bold active:text-sprout-600";

	return (
		<div class="opacity-90 max-w-4/5">
								...
								<li class="list-disc marker:text-sprout-400 my-0">
									<span>
										<a
											href={`#${section().id}`}
											classList={{
												"text-sprout-500 hover:text-sprout-700 font-semibold":
