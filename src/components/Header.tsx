		...
		<header class={`${props.sticky ? "sticky" : ""} backdrop-blur-sm top-0 w-screen flex items-center justify-between mx-3 xl:mx-5 2xl:mx-6`}>
			...
			>
				<div class="relative h-4 w-auto">
					<div class="absolute h-4 w-4 -top-1.5 -left-1.5 group-hover:top-1.5 group-hover:left-1.5 bg-sprout-300 dark:bg-sprout-400 rounded-sm transition-all duration-500 group-hover:bg-sprout-200 transform-gpu" />
