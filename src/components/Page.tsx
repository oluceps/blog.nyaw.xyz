...
import { Show, type ParentComponent, children, Suspense, For, Switch, createSignal, createEffect } from "solid-js";
						...
						return (
							<>
								...
								<div class="antialiased prose font-sans md:max-w-2/3 2xl:prose-lg dark:prose-invert mx-auto w-full mt-10 break-words">
									<h1 class="font-sans font-medium prose-h1 whitespace-nowrap">
										{article?.title}
										<Show when={article?.draft}>
											{" [draft]"}
										</Show>
								...
								<Show when={article?.toc && clientWidthGt900()} fallback={
									<article class="antialiased prose font-sans md:max-w-2/3 2xl:prose-lg mx-auto w-full break-words">
										...
										<div class="w-full prose font-sans lg:prose-lg 2xl:prose-xl mb-16 ">
											{resolved()}
										</div>
									</article>
								}>
									<article class="justify-between flex grow mx-16 mx-2 xl:mx-1/6">
										<div class="w-1/8">
											<div class="fixed top-2/5 left-8 xl:left-32 3xl:left-64 4xl:left-128 z-10">
												<TableOfContents children={resolved()} />
											</div>
										</div>
