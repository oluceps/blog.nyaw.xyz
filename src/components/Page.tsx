				...
				{(articleData) => {
					...
					return (
						<>
							...
							/>
							<Meta property="og:title" content={`${articleData().title} - ${cfg.title}`} />
							<Meta property="og:description" content={articleData().description || cfg.description} />
							<Meta name="keywords" content={articleData().tags?.join(",")} />
							<Meta name="twitter:card" content="summary_large_image" />
							<Meta name="twitter:title" content={`${articleData().title} - ${cfg.title}`} />
							<Meta name="twitter:description" content={articleData().description || cfg.description} />
