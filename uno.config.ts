...
export default defineConfig({
	...
	theme: {
		...
		animation: {
			keyframes: {
				expand:
					"{0% { height: 0px; } 100% { height: var(--corvu-disclosure-content-height); }}",
				collapse:
					"{0% { height: var(--corvu-disclosure-content-height); } 100% { height: 0px; }}",
			},
			durations: {
				expand: "300ms",
				collapse: "200ms",
	...
	presets: [
		...
		presetTypography({
			cssExtend: {
				...
				pre: {
					color: "#393a34", // Match vitesse-light default color
				},
				"pre code": {
					color: "inherit",
				},
