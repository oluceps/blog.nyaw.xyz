 ...
 */
export function setupLogging(log_level) {
...
export class PublicKey {
     ...
     * @param {string} lines_str
     * @returns {PublicKey}
     */
    static decode(lines_str) {
        const ptr0 = passStringToWasm0(lines_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.publickey_decode(ptr0, len0);
...
export class Signature {
    ...
    static decode(lines_str) {
        const ptr0 = passStringToWasm0(lines_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.signature_decode(ptr0, len0);
